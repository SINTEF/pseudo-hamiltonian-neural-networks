...
class CasadiPortHamiltonianSystem:
    """
    Casadi implementation of the port-Hamiltonian framework, modeling a system of the form
    ...
    def __init__(self, S, dH, u, R=None, F=None):
        ...
        if R is None:
            ...
            self.R = R
        assert self.R.shape == S.shape, (f'R must be of size (nstates, nstates), same as S ({S.shape}), '
